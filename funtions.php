<?php
/**
 * Franko functions and definations.
 */

if ( ! function_exists( 'Franko_setup' ) ) {
    /**
	 ...
	 */
    function Franko_setup() {
        /*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Crafty Press, use a find and replace
		 * to change 'Franko' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'Franko', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary', 'Franko' ),
            'footer' => esc_html__( 'Footer Menu', 'Franko' ),
            'header_action' => esc_html__( 'Header Action', 'Franko' ),
		) );

		add_filter( 'show_admin_bar', '__return_false' );
    }
}
add_action( 'after_setup_theme', 'Franko_setup' );
 ...
 */
function Franko_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'Franko_content_width', 1170 );
}
add_action( 'after_setup_theme', 'Franko_content_width', 0 );
 ...
 * @since 1.0.0
 */
function Franko_sidebar_widgets_init() {
	// Default Sidebar
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'Franko' ),
		'id'            => 'default-sidebar',
		'description'   => esc_html__( 'Add widgets here.', 'Franko' ),
 ...
 */
function Franko_public_scripts() {
    // Styles.
...
add_action( 'wp_enqueue_scripts', 'Franko_public_scripts' );

/**
 * Enqueue admin scripts and styles.
 */
function Franko_admin_scripts() {

}
add_action( 'admin_enqueue_scripts', 'Franko_admin_scripts' );